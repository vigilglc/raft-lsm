...
type InternalRequest struct {
	...
	AddMember     *AddMemberRequest     `protobuf:"bytes,6,opt,name=addMember,proto3" json:"addMember,omitempty"`
	PromoteMember *PromoteMemberRequest `protobuf:"bytes,7,opt,name=promoteMember,proto3" json:"promoteMember,omitempty"`
	RemoveMember  *RemoveMemberRequest  `protobuf:"bytes,8,opt,name=removeMember,proto3" json:"removeMember,omitempty"`
}
...
func (m *InternalRequest) GetAddMember() *AddMemberRequest {
	if m != nil {
		return m.AddMember
	}
	return nil
...
func (m *InternalRequest) GetPromoteMember() *PromoteMemberRequest {
	if m != nil {
		return m.PromoteMember
	}
	return nil
}

func (m *InternalRequest) GetRemoveMember() *RemoveMemberRequest {
	if m != nil {
...
func init() {
	proto.RegisterType((*InternalRequest)(nil), "api.InternalRequest")
}
...
var fileDescriptor_41cbac4e1e0b130d = []byte{
	...
	,
}
...
func (m *InternalRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RemoveMember != nil {
		{
			size, err := m.RemoveMember.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.PromoteMember != nil {
		{
			size, err := m.PromoteMember.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.AddMember != nil {
		{
			size, err := m.AddMember.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *InternalRequest) Size() (n int) {
	...
	if m.PromoteMember != nil {
		l = m.PromoteMember.Size()
		n += 1 + l + sovInternalReq(uint64(l))
	}
	if m.RemoveMember != nil {
		l = m.RemoveMember.Size()
		n += 1 + l + sovInternalReq(uint64(l))
	}
	return n
}
...
func (m *InternalRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.AddMember == nil {
				m.AddMember = &AddMemberRequest{}
			}
			if err := m.AddMember.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PromoteMember", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PromoteMember == nil {
				m.PromoteMember = &PromoteMemberRequest{}
			}
			if err := m.PromoteMember.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			...
			if m.RemoveMember == nil {
				m.RemoveMember = &RemoveMemberRequest{}
			}
			if err := m.RemoveMember.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
